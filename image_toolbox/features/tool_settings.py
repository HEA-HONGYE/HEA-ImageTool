...
class ToolSettingsPanel(QWidget):
    ...
    def _build(self) -> None:
        ...
        hint = QLabel("管理视频处理运行依赖：FFmpeg、FFprobe、RIFE、IFRNet、CAIN。模型仍在项目模型库中管理，工具目录只放可执行程序和 DLL。")
    ...
    def _build_path_group(self) -> QWidget:
        ...
        for tool_id in ["ffmpeg", "ffprobe", "rife", "ifrnet", "cain"]:
    ...
    def refresh(self) -> None:
        ...
        if self.table:
            ...
            for row, tool_id in enumerate(["ffmpeg", "ffprobe", "rife", "ifrnet", "cain"]):
